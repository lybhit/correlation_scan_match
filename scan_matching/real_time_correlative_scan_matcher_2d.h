...
class RealTimeCorrelativeScanMatcher2D {
 public:
  ...
  explicit RealTimeCorrelativeScanMatcher2D(double linear_window,
                                            double angular_window,
                                            double translation_cost_weight,
                                            double rotation_cost_weight)
                                            :linear_search_window(linear_window),
                                            angular_search_window(angular_window),
                                            translation_delta_cost_weight(translation_cost_weight),
                                            rotation_delta_cost_weight(rotation_cost_weight){};
